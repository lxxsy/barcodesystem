    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pftype', models.IntegerField(blank=True, choices=[(0, '标准配方'), (1, '比例配方')], default=0, null=True, verbose_name='配方类型(0：标准配方；1：比例配方)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dw', models.CharField(blank=True, choices=[('0', 'kg'), ('1', 'g')], default='0', max_length=20, null=True, verbose_name='单位(Kg or g)')),
