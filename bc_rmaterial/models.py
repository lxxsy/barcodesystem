...
class Ylinfo(models.Model):
    ...
    zbq = models.IntegerField(default=365, verbose_name='最长质保期(天)')
    goodzbq = models.IntegerField(default=365, verbose_name='最佳质保期(天)')
    ...
    ylzt = models.BooleanField(default=True, verbose_name='原料状态，默认可用')
